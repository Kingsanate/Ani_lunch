...
class AdminTheme {
  ...
  static Color statusColor(String status) {
    switch (status.toLowerCase()) {
      ...
      case 'accepted':         return const Color(0xFF7C3AED); // purple — rider en route
      case 'picked_up':        return const Color(0xFF0891B2); // cyan — picked up
      case 'ready_for_pickup': return const Color(0xFF16A34A); // green — food ready
      case 'preparing':        return const Color(0xFF2563EB); // blue — being prepared
