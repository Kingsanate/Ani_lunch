...
class AniApi {
  ...
  static Future<AniApi> ensureInitialized({String? baseUrl}) async {
    ...
    if (tokens.accessToken != null) {
      try {
        ...
        debugPrint('WebSocket connect notice on startup: $e');
      }
    }
  ...
  /// Sets tokens and connects the realtime gateway upon login/register.
  ...
  /// Clears tokens and disconnects realtime on sign out.
