...
// in anilunch/test/services/auth_service_test.dart.
...
class MockPostgrestClient extends _i1.Mock implements _i2.PostgrestClient {
  ...
  bool get retryEnabled =>
      (super.noSuchMethod(Invocation.getter(#retryEnabled), returnValue: false)
          as bool);
...
class MockPostgrestQueryBuilder<T> extends _i1.Mock
  ...
  _i2.PostgrestQueryBuilder<T> retry({required bool? enabled}) =>
      (super.noSuchMethod(
            ...
            returnValue: _FakePostgrestQueryBuilder_20<T>(
              this,
              Invocation.method(#retry, [], {#enabled: enabled}),
            ),
          )
