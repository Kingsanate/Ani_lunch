        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('AniLunch Kitchen', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: AdminTheme.dark)),
              const SizedBox(height: 4),
              const Text('Sign in to manage your kitchen orders', style: TextStyle(fontSize: 12, color: AdminTheme.textMuted)),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: AdminTheme.inputDecoration('vendor@example.com'),
                    ),
                    const SizedBox(height: 14),
